    ...
    <div className="min-h-screen bg-base-200">
      ...
      <main className="w-[97%] mx-auto mt-5 p-6 flex flex-col bg-cyan-50 text-black rounded-lg shadow-lg">
        ...
        <section className="w-[85%] mx-auto mb-12">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="p-2 border rounded-lg">{movie.Plot}</p>

              <div className="flex flex-wrap gap-3">
                {movie.Ratings?.map((rating: any, idx: number) => (
                  <div key={idx} className="text-sm ml-3"> {/* Kept ml-3 from File 1 */}
                    <strong>
        ...
        <section className="w-[85%] mx-auto mb-12">
          ...
          {/* Reviews */}
          <hr />
          <div className="mt-8 space-y-4"> {/* File 2 had mt-8, File 1 had hr */}
            {localReviews.length === 0 ? (
              <p className="text-center">No reviews yet</p>
            ) : (
              localReviews.map((item, i) => (
                // Review Item: Matched File 1 (gap-2, p-3)
                <div
                  key={i}
                ...
                >
                  ...
                  <div className="w-[80%]">
                    <div className="rating rating-sm"> {/* Matched File 1 */}
                      {[1, 2, 3, 4, 5].map((val) => (
                        <input
                          key={val}
                          type="radio"
        ...
        <section className="w-[85%] mx-auto mb-12">
          ...
          {loading ? (
            ...
            // Rec container: Matched File 1 (removed gap-4)
